...
public class ItemOsmiumArmor extends ItemArmor implements IArmorTextureProvider{
	...
	public String getArmorTextureFile(ItemStack itemstack) {
		if(itemstack.itemID == BaseForgeSMOA.OsmiumHelmet.itemID || itemstack.itemID == BaseForgeSMOA.OsmiumPlate.itemID || itemstack.itemID == BaseForgeSMOA.OsmiumBoots.itemID){
		return "/armor/Osmium_1.png";
		}
		
		if(itemstack.itemID == BaseForgeSMOA.OsmiumLegs.itemID){
