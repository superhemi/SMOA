...
public class Strings {
    ...
    public static final String OSMIUM_AXE_NAME = "OsmiumAxe";
    public static final String OSMIUM_BUCKET_NAME = "OsmiumBucket";
    public static final String OSMIUM_FISHPOLE_NAME = "OsmiumFishpole";
    public static final String OSMIUM_HOE_NAME = "OsmiumHoe";
    public static final String OSMIUM_INGOT_NAME = "OsmiumIngot";
    public static final String OSMIUM_PICKAXE_NAME = "OsmiumPickaxe";
    public static final String OSMIUM_SHEARS_NAME = "OsmiumShears";
    public static final String OSMIUM_SPADE_NAME = "OsmiumSpade";
    public static final String OSMIUM_SWORD_NAME  = "OsmiumSword";     
