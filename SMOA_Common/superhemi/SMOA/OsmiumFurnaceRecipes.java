...
public class OsmiumFurnaceRecipes
{
    private static final OsmiumFurnaceRecipes smeltingBase = new OsmiumFurnaceRecipes();
     ...
     */
    public static final OsmiumFurnaceRecipes smelting()
    {
        return smeltingBase;
    }

    private OsmiumFurnaceRecipes()
    {
