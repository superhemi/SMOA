package superhemi.SMOA.tileentity;

import superhemi.SMOA.OsmiumFurnaceRecipes;
import superhemi.SMOA.block.OsmiumFurnace;
...
public abstract class TileEntityOsmiumFurnace extends TileEntity implements ISidedInventory
{
    ...
    {
        return this.isInvNameLocalized() ? this.field_94130_e : "Osmium Furnace";
    }
    ...
    public void readFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        if (par1NBTTagCompound.hasKey("Osmium Furnace"))
        {
    ...
    public void writeToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        {
            par1NBTTagCompound.setString("Osmium Furnace", this.field_94130_e);
        }
    }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                OsmiumFurnace.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = OsmiumFurnaceRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
    ...
    public static int getItemBurnTime(ItemStack par0ItemStack)
    {
        ...
        else
        {
            ...
            if (i == ModItems.OsmiumIngot.itemID) return 100;
